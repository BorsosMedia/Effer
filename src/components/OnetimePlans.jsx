...
function OnetimePlans() {
  return (
    <section className="single-plans--container">
      <h2 className="big-text">One Time Custom Plans</h2>
      <div className="plans-container">
        <div className="one-time-plan--block">
          <h2 className="medium-text">One Time Meal Plan</h2>
        ...
        <div className="one-time-plan--block">
          <h2 className="medium-text">One Time Training Plan</h2>
        ...
        <div className="one-time-plan--block">
          <h2 className="medium-text">One Time Training & Meal Plan </h2>
